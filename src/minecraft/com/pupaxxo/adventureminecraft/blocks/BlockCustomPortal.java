...
import com.pupaxxo.adventureminecraft.dimension.DimensionTeleporter;

public class BlockCustomPortal extends BlockPortal{
	 public BlockCustomPortal(int id, int texture)
	 {
		 super(id, texture);
	 ...
	 public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
	 {
	  if (par5Entity.ridingEntity == null && par5Entity.riddenByEntity == null)
	  {
	   if (par5Entity instanceof EntityPlayerMP)
	   {
	    ...
	    if (par5Entity.dimension != Dimension.dim1ID)
	    {
	     thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Dimension.dim1ID, new DimensionTeleporter(thePlayer.mcServer.worldServerForDimension(Dimension.dim1ID)));
	    }
	    else
	    {
	     thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new DimensionTeleporter(thePlayer.mcServer.worldServerForDimension(0)));
	    }
	   }
	  }
	 }
