...
public class DimensionTeleporter extends Teleporter
{
	 ...
	 private final List field_85190_d = new ArrayList();
	  ...
	  public DimensionTeleporter(WorldServer par1WorldServer)
	 {
	 ...
	 public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
	 {
	  ...
	  else
	  {
	   for (var48 = var15 - var9; var48 <= var15 + var9; ++var48)
	   {
	     ...
	     for (int var23 = var16 - var9; var23 <= var16 + var9; ++var23)
	    {
	     ...
	     {
	      if (this.field_85192_a.getBlockId(var48, var26, var23) == 251)
	      {
	       while (this.field_85192_a.getBlockId(var48, var26 - 1, var23) == 251)
	       {
	        --var26;
	       }
	   ...
	   if (var10 >= 0.0D)
	  {
	   ...
	   int var50 = -1;
	    ...
	    if (this.field_85192_a.getBlockId(var12 - 1, var13, var14) == 251)
	   {
	    var50 = 2;
	   }
	    ...
	    if (this.field_85192_a.getBlockId(var12 + 1, var13, var14) == 251)
	   {
	    ...
	    if (this.field_85192_a.getBlockId(var12, var13, var14 - 1) == 251)
	   {
	    var50 = 3;
	   }
	   ...
	   for (var19 = 0; var19 < 4; ++var19)
	  {
	    ...
	    for (var20 = 0; var20 < 4; ++var20)
	   {
	    for (var21 = -1; var21 < 4; ++var21)
	    {
	     ...
	     this.field_85192_a.setBlockWithNotify(var22, var23, var24, var33 ? Block.sandStone.blockID : 251);
	    }
	   }
